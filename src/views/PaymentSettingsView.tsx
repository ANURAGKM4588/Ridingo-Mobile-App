    ...
    <div className="w-full max-w-xl mx-auto space-y-4 animate-fade-in pb-4">
      ...
      <div className="bg-white/95 backdrop-blur-md border-t border-slate-200 p-3 px-4 flex-shrink-0 shadow-lg z-30">
        <button
          type="button"
          onClick={onBack}
          className="w-full py-3 rounded-2xl bg-[#84CC16] hover:bg-lime-400 text-[#121212] font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-[0.98] cursor-pointer"
        >
