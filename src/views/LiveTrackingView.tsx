...
export const LiveTrackingView: React.FC<LiveTrackingViewProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-screen flex flex-col overflow-hidden bg-slate-900 animate-fade-in">
      ...
      {/* Top Safe Area Buffer (Pure transparent spacing for notch, zero header content) */}
      <div className="shrink-0 sticky top-0 z-30 w-full pt-[max(env(safe-area-inset-top),44px)] bg-transparent pointer-events-none" />
