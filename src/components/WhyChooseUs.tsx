...
export const WhyChooseUs: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      color: 'bg-[#fcd502]/15 text-[#fcd502]',
    },
    {
      icon: Navigation,
      title: 'Real-Time GPS',
      ...
      <div className="grid grid-cols-2 gap-2">
        {features.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="rounded-2xl p-3 flex flex-col justify-between border border-white/10 hover:border-white/20 transition-all bg-[#131926]"
            >
