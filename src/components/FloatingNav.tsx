        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center justify-center gap-1.5 py-2.5 px-4 rounded-full transition-all duration-300 cursor-pointer ${
                isActive
            ...
            >
              <Icon className={`w-4.5 h-4.5 transition-transform duration-300 ${isActive ? 'scale-110 text-[#84CC16]' : ''}`} />
